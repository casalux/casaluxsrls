...
(function(){
  ...
  if(form){
    ...
    form.addEventListener('submit',function(e){
      ...
      var fd=new FormData();
      fd.append('access_key','72d60b09-3526-463b-820e-444ecc351c16');
      fd.append('subject','Nuova richiesta dal sito Casalux');
      fd.append('Nome',form.nome.value);
      fd.append('Cognome',form.cognome.value);
      fd.append('Email',form.email.value);
      fd.append('Telefono',form.tel.value);
      fd.append('Messaggio',form.msg.value);
